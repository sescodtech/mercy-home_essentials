        ...
        <div className="relative aspect-[4/5] rounded-2xl overflow-hidden bg-gray-50 mb-6">
          ...
          <div className="absolute inset-0 bg-dark/40 opacity-0 group-hover:opacity-100 transition-all duration-300 flex items-center justify-center gap-3 backdrop-blur-sm">
            <button
              ...
              className="p-3 rounded-full bg-white text-dark hover:bg-white shadow-xl transition-all hover:scale-110 active:scale-95"
              title="Quick view"
            >
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex-1 py-3 px-4 rounded-2xl bg-dark text-white hover:bg-accent transition-all duration-300 font-bold text-sm flex items-center justify-center gap-2 group-hover:translate-y-[-2px]"
            >
